//Code for Controls/BuildingButtonIcon (Container)
using GumRuntime;
using MonoGameGum;
...
partial class BuildingButtonIcon : MonoGameGum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/BuildingButtonIcon");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new BuildingButtonIcon(visual);
            return visual;
        });
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(BuildingButtonIcon)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Controls/BuildingButtonIcon", () => 
        {
    ...
    public BuildingButtonIcon(InteractiveGue visual) : base(visual)
    {
    }
    public BuildingButtonIcon()
    {
