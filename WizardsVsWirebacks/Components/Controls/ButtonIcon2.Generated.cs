//Code for Controls/ButtonIcon2 (Container)
using GumRuntime;
using MonoGameGum;
...
partial class ButtonIcon2 : MonoGameGum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/ButtonIcon2");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new ButtonIcon2(visual);
            return visual;
        });
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(ButtonIcon2)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Controls/ButtonIcon2", () => 
        {
    ...
    public ButtonIcon2(InteractiveGue visual) : base(visual)
    {
    }
    public ButtonIcon2()
    {
