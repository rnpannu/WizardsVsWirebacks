//Code for Controls/ButtonStandard1 (Container)
using GumRuntime;
using MonoGameGum;
...
partial class ButtonStandard1 : MonoGameGum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/ButtonStandard1");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new ButtonStandard1(visual);
            return visual;
        });
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(ButtonStandard1)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Controls/ButtonStandard1", () => 
        {
    ...
    public ButtonStandard1(InteractiveGue visual) : base(visual)
    {
    }
    public ButtonStandard1()
    {
