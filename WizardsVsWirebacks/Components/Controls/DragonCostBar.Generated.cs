//Code for Controls/DragonCostBar (Container)
using GumRuntime;
using MonoGameGum;
...
partial class DragonCostBar : MonoGameGum.Forms.Controls.TextBox
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/DragonCostBar");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new DragonCostBar(visual);
            return visual;
        });
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(DragonCostBar)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Controls/DragonCostBar", () => 
        {
    ...
    public DragonCostBar(InteractiveGue visual) : base(visual)
    {
    }
    public DragonCostBar()
    {
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        ClipContainer = this.Visual?.GetGraphicalUiElementByName("ClipContainer") as ContainerRuntime;
