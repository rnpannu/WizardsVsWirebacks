//Code for Controls/TextBox1 (Container)
using GumRuntime;
using MonoGameGum;
...
partial class TextBox1 : MonoGameGum.Forms.Controls.TextBox
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/TextBox1");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new TextBox1(visual);
            return visual;
        });
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(TextBox1)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Controls/TextBox1", () => 
        {
    ...
    public TextBox1(InteractiveGue visual) : base(visual)
    {
    }
    public TextBox1()
    {
