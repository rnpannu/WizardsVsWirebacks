//Code for WizardsVsWirebacks/BuildingPanel (Container)
using GumRuntime;
using MonoGameGum;
...
partial class BuildingPanel : MonoGameGum.Forms.Controls.ListBox
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("WizardsVsWirebacks/BuildingPanel");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new BuildingPanel(visual);
            return visual;
        });
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(BuildingPanel)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("WizardsVsWirebacks/BuildingPanel", () => 
        {
    ...
    public BuildingPanel(InteractiveGue visual) : base(visual)
    {
    }
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        ClipAndScrollContainer = this.Visual?.GetGraphicalUiElementByName("ClipAndScrollContainer") as ContainerRuntime;
        ClipContainerParent = this.Visual?.GetGraphicalUiElementByName("ClipContainerParent") as ContainerRuntime;
        CustomInitialize();
    }
