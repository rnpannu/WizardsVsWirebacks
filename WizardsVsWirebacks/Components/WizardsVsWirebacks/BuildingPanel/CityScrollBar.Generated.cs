//Code for WizardsVsWirebacks/BuildingPanel/CityScrollBar (Container)
using GumRuntime;
using MonoGameGum;
...
partial class CityScrollBar : MonoGameGum.Forms.Controls.ScrollBar
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("WizardsVsWirebacks/BuildingPanel/CityScrollBar");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new CityScrollBar(visual);
            return visual;
        });
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(CityScrollBar)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("WizardsVsWirebacks/BuildingPanel/CityScrollBar", () => 
        {
    ...
    public CityScrollBar(InteractiveGue visual) : base(visual)
    {
    }
    public CityScrollBar()
    {
