//Code for WizardsVsWirebacks/ListBox (Container)
using GumRuntime;
using MonoGameGum;
...
partial class ListBox : MonoGameGum.Forms.Controls.ListBox
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("WizardsVsWirebacks/ListBox");
        ...
        ElementSaveExtensions.RegisterGueInstantiation("WizardsVsWirebacks/ListBox", () => 
        {
