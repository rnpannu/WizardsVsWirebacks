//Code for WizardsVsWirebacks/Menu (Container)
using GumRuntime;
using MonoGameGum;
...
partial class Menu : MonoGameGum.Forms.Controls.Menu
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("WizardsVsWirebacks/Menu");
        ...
        ElementSaveExtensions.RegisterGueInstantiation("WizardsVsWirebacks/Menu", () => 
        {
