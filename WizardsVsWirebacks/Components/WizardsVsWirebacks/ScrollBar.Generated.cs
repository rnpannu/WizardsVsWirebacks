//Code for WizardsVsWirebacks/ScrollBar (Container)
using GumRuntime;
using MonoGameGum;
...
partial class ScrollBar : MonoGameGum.Forms.Controls.ScrollBar
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("WizardsVsWirebacks/ScrollBar");
        ...
        ElementSaveExtensions.RegisterGueInstantiation("WizardsVsWirebacks/ScrollBar", () => 
        {
