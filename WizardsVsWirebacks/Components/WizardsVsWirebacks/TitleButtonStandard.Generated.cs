//Code for WizardsVsWirebacks/TitleButtonStandard (Container)
using GumRuntime;
using MonoGameGum;
...
partial class TitleButtonStandard : MonoGameGum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("WizardsVsWirebacks/TitleButtonStandard");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new TitleButtonStandard(visual);
            return visual;
        });
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(TitleButtonStandard)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("WizardsVsWirebacks/TitleButtonStandard", () => 
        {
    ...
    public TitleButtonStandard(InteractiveGue visual) : base(visual)
    {
    }
    public TitleButtonStandard()
    {
