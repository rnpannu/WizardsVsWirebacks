//Code for WizardsVsWirebacks/TreeView (Container)
using GumRuntime;
using MonoGameGum;
...
partial class TreeView : MonoGameGum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("WizardsVsWirebacks/TreeView");
        ...
        ElementSaveExtensions.RegisterGueInstantiation("WizardsVsWirebacks/TreeView", () => 
        {
